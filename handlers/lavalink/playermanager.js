    ...
    /*  if(res.tracks[0].duration > 3 * 60 * 60 * 1000){
      ...
      //otherwise
          ...
          let playembed = new Discord.MessageEmbed()
            ...
            .setTitle("**" + res.tracks[0].title + "**").setColor(ee.embedcolor)
    ...
    function playlist_() {
      ...
      var time = 0;
        let playlistembed = new Discord.MessageEmbed()
          ...
          //if bot allowed to send embed, do it otherwise pure txt msg
          if(message.guild.me.permissionsIn(message.channel).has("EMBED_LINKS"))
            message.channel.send(playlistembed).then(m => m.delete({timeout: 5000}));
          else
